...
const CreditForm: React.FC = () => {
  ...
  const handleSubmit = (data: CreditFormData) => {
        ...
        <form onSubmit={methods.handleSubmit(handleSubmit)} className={classes.form}>
          ...
          <FormGroup className={classes.formContainer}>
            <Select
              ...
              defaultValue={Category.FREIE_VERWENDUNG}
            >
          ...
          {methods.watch('category') === Category.AUTO_MOTRAD && (
            <CurrencyTextField
              ...
              helperText={
                `Bei einem Kaufpreis von ${creditAmount.toLocaleString()} € darf die Anzahlung höchstens ${formatCurrency(creditAmount - 500)} betragen.`
              }
